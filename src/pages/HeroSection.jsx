...
const HeroSection = ({ onSplineReady }) => {
  ...
  return (
    <section
      id="hero"
      className="relative pt-20 pb-20 md:pt-32 md:pb-24 flex flex-col justify-center items-center text-center overflow-hidden min-h-[calc(100vh-4rem)]"
    >
      ...
      <div className="relative z-20 container mx-auto px-4">
        ...
        <h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 mb-6 animate-fade-in-up"
          style={{ animationDelay: "0.2s" }}
        >
          From Idea to IPO — We’re With You.
        </h1>
        <p
          className="max-w-3xl mx-auto text-lg md:text-xl text-text-secondary mb-10 animate-fade-in-up"
